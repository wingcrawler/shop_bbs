					...
					<div class="g-tabWrap">
						<div class="g-tabHdWrap">
							<ul class="g-tabHd">
								...
								<li class="<c:if test="${type==2 }">f-active</c:if>">
									<span><a href="/front/sell/messagePage?type=3">${t.t_myletter}</a></span>
								</li>
							</ul>
						</div>
						<div class="g-tabMn">
										...
										<div class="item">
											...
											<div class="edit" style="display:none;">
												...
												<div class="edit_btn">
													...
													<span class="affirm" productId="${item.productId }" commentId="${item.commentId }" replyToId="${item.commentUserId }" messageId="">${t.b_confirm }</span>
												</div>
											</div>
										</div>
												...
												<c:forEach var="reply" items="${item.replyList }">
													<li>
														<p class="quietly">
															...
															<span>${t.t_reply }</span>
															<span class="red">${reply.reciveName }：</span>
...
$(function(){
	...
	$('.affirm').click(function(){
		...
		jQuery.common.updateObjByParm(parm,'/front/sell/messageReply',true,'/front/sell/messagePage?type=1');
	});
	//取消回复
