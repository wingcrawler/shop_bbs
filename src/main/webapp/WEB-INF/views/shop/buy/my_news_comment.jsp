	...
	<div class="main">
		...
		<div class="container">
			...
			<div class="companyData">
				<div class="header"><span>${t.t_user_center }>  ${t.t_my_news_comment }</span></div>
...
$(function(){
	...
	$('.affirm').click(function(){
		...
		jQuery.common.updateObjByParm(parm,'/front/sell/messageReply',true,window.location.href);
	});
	//取消回复
