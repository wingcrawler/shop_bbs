...
<link href="/frontstyle/buy/css/leave_message.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	...
	<div class="main">
		...
		<div class="container">
			...
			<div class="companyData">
				<div class="header">
					<span>${t.t_user_center } > ${t.t_my_message }</span>
				</div>
				<div class="product_message">
					<div class="g-tabWrap">
						<div class="g-tabHdWrap">
							<ul class="g-tabHd">
							<!-- 网页重新设计 -->
								<li class="f-active"><span>所有信息</span></li>
								<li class="f-active"><span>用户信息</span></li>  
								<li class="f-active"><span>系统信息</span></li>
							</ul>
						</div>
						<div class="g-tabMn">
										...
										<div class="item">
											...
											<div class="content">
												...
												<div class="introduce">
													...
													<p class="tariff">${t.t_price }：¥<span>${item.price }</span>
													</p>
												</div>
											</div>
											...
											<div class="edit" style="display: none;">
												...
												<div class="edit_btn">
													<span class="cancel">${t.b_cancel }</span> <span
														class="affirm" productId="${item.productId }"
														commentId="${item.commentId }"
														replyToId="${item.receiveId }"
														messageId="${item.messageId }">${t.b_confirm }</span>
												</div>
											</div>
										</div>
										<div class="write_back_box">
											<ul class="write_back">
												<c:forEach var="reply" items="${item.replyList }">
													<li>
														<p class="quietly">
															<span class="red">${reply.postName }</span> <span>${t.t_reply }</span>
															<span class="red">${reply.receiveName }：</span> <span>${reply.content }
																<span style="margin-left: 30px; color: #aaa;">${reply.date }</span>
															</span>
														</p> <%-- <p class="reply_box">
															<span>2016-06-27 17:55</span>
		...
		$(function() {
			...
			$('.affirm').click(
					function() {
						...
						parm.type = 2;
						jQuery.common.updateObjByParm(parm,
								'/front/buy/messageReply', true,
