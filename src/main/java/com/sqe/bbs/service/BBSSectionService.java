...
import com.sqe.bbs.mapper.BBSSectionMapper;
import com.sqe.shop.common.Constants;
import com.sqe.shop.mapper.SectionMapper;
import com.sqe.shop.model.Section;
import com.sqe.shop.service.AdapterService;
import com.sqe.shop.service.BaseService;
...
public class BBSSectionService extends AdapterService implements BaseService {
	 ...
	 * @return
	 */
	public PageUtil<Section> getBeanListByParm(Section section, int ParentId, int pageNo, Integer pageSize) {
		PageUtil<Section> pageUtil = new PageUtil<Section>(pageNo, pageSize);
		Map<String, Object> parm = queryParm(section);
		parm.put("start", pageUtil.getStartRow());
		parm.put("limit", pageUtil.getPageSize());
