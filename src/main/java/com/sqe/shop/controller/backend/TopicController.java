...
public class TopicController extends BaseController {
	...
	public ModelAndView index() {
		ModelAndView model = new ModelAndView("backend/topic/list");
		return model;
	}
	
	@RequestMapping(value="/edit", method = RequestMethod.GET)
	public ModelAndView edit(Long id) {
		ModelAndView model = new ModelAndView("backend/topic/edit");
		if(id!=null){
	...
	public Map<String, Object> getList(Topic topic,
		...
		PageUtil<Topic> page = topicService.getBeanListByParm(topic, pageNo, pageSize);
